...
namespace SM64Mod
{
  ...
  public class SM64Plugin : BaseUnityPlugin
  {
    ...
    public const string PLUGIN_GUID = "com.earthlingOnFire.ultra64";
    public const string PLUGIN_NAME = "Ultra64";
    ...
    public void InitializeSM64()
    {
      ...
      try
      {
        rom = File.ReadAllBytes("Super Mario 64 (USA).z64");
      }
    ...
    {
      /*Logger.LogMessage($"{scene.buildIndex} {scene.name} {SceneHelper.CurrentScene}");*/
    ...
    public void ReplaceWithMario(GameObject p) {
      ...
      if (p != null)
      {
        ...
        /*  if (material == null && r[i].material.shader.name.StartsWith("ULTRAKILL"))*/
        /*    material = Material.Instantiate<Material>(r[i].material);*/
        /*}*/
        material = Material.Instantiate<Material>(r[0].material);
        ...
        marioObj.transform.position = p.transform.position + Vector3.up*2;
...
public static class Patches {
  ...
  /*public static void NewMovement_ActivatePlayer_Postfix() {*/
  /*  SM64Plugin.Logger.LogMessage("Replacing player with Mario!");*/
  /*  SM64Plugin.Instance.ReplaceWithMario();*/
  /*}*/
  [HarmonyPostfix]
  [HarmonyPatch(typeof(PlatformerMovement), "Start")]
  public static void NewMovement_ActivatePlayer_Postfix(PlatformerMovement __instance) {
    SM64Plugin.Logger.LogMessage("Replacing player with Mario!");
    SM64Plugin.Instance.ReplaceWithMario(__instance.gameObject);
  }
